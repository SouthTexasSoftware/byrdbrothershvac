...
<div
  class="fixed bottom-4 left-4 right-4 z-50 flex flex-col-reverse space-y-reverse space-y-2 md:left-1/2 md:right-auto md:-translate-x-1/2 md:max-w-sm md:w-80"
>
